...
from ena_portal_api.models.analysis import AnalysisFields
from ena_portal_api.query.base import (
    BaseENAQueryConditions,
    ENAQueryClause,
    ENAQueryPair,
)
...
class ENAAPIRequest(BaseModel):
    ...
    query: Optional[
        Union[BaseENAQueryConditions, ENAQueryClause, ENAQueryPair]
    ] = Field(default=None)
    fields: Union[List[Union[StudyFields, ReadRunFields, AnalysisFields]]]
    ...
    def _get_types_for_result(self) -> Tuple[Type, Type]:
        ...
        Convention:
        - For result type 'study' -> StudyFields and St,udyQuery in models.study
    ...
    def _validate_query_pair_types(
        self, query_pair: ENAQueryPair, expected_type: Type[BaseENAQueryConditions]
    ):
