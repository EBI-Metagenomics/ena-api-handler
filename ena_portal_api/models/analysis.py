...
class AnalysisFields(str, Enum):
    ...
    ANALYSIS_TILE = "analysis_title" #  brief sequence analysis description
...
class AnalysisQuery(BaseENAQueryConditions):
    ...
    analysis_type: Optional[Literal["SEQUENCY_ASSEMBLY", "REFERENCE_ALIGNMENT"]] = Field(
        "SEQUENCY_ASSEMBLY", description="Type of sequence analysis"
    )
    ...
    generated_aspera: Optional[str] = Field(None, description="Aspera links for generated file")
    generated_bytes: Optional[str] = Field(None, description="size (in bytes) of generated files")
    generated_ftp: Optional[str] = Field(None, description="FTP links for generated files")
    generated_galaxy: Optional[str] = Field(None, description="Galaxy links for generated files")
    generated_md5: Optional[str] = Field(None, description="MD5 checksum of generated files")
    ...
    submitted_aspera: Optional[str] = Field(None, description="Aspera links for submitted file")
    submitted_bytes: Optional[str] = Field(None, description="size (in bytes) of submitted files")
    submitted_ftp: Optional[str] = Field(None, description="FTP links for submitted files")
    submitted_galaxy: Optional[str] = Field(None, description="Galaxy links for submitted files")
