...
# Portal: faang | Result type: read_experiment
...
class FAANGReadExperimentFields(str, Enum):
    """Returnable fields for read_experiment via the faang portal."""
...
class FAANGReadExperimentQuery(ENABaseQuery):
    """Searchable fields for read_experiment via the faang portal."""
...
class FAANGReadExperimentResult(BaseModel):
    """Typed result row for read_experiment via the faang portal."""
