...
# Portal: faang | Result type: tls_set
...
class FAANGTlsSetFields(str, Enum):
    """Returnable fields for tls_set via the faang portal."""
...
class FAANGTlsSetQuery(ENABaseQuery):
    """Searchable fields for tls_set via the faang portal."""
...
class FAANGTlsSetResult(BaseModel):
    """Typed result row for tls_set via the faang portal."""
