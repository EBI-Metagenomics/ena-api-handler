...
# Portal: faang | Result type: assembly
...
class FAANGAssemblyFields(str, Enum):
    """Returnable fields for assembly via the faang portal."""
...
class FAANGAssemblyQuery(ENABaseQuery):
    """Searchable fields for assembly via the faang portal."""
...
class FAANGAssemblyResult(BaseModel):
    """Typed result row for assembly via the faang portal."""
