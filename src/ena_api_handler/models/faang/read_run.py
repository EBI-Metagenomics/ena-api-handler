...
# Portal: faang | Result type: read_run
...
class FAANGReadRunFields(str, Enum):
    """Returnable fields for read_run via the faang portal."""
...
class FAANGReadRunQuery(ENABaseQuery):
    """Searchable fields for read_run via the faang portal."""
...
class FAANGReadRunResult(BaseModel):
    """Typed result row for read_run via the faang portal."""
