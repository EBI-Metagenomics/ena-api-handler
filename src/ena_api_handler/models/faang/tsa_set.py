...
# Portal: faang | Result type: tsa_set
...
class FAANGTsaSetFields(str, Enum):
    """Returnable fields for tsa_set via the faang portal."""
...
class FAANGTsaSetQuery(ENABaseQuery):
    """Searchable fields for tsa_set via the faang portal."""
...
class FAANGTsaSetResult(BaseModel):
    """Typed result row for tsa_set via the faang portal."""
