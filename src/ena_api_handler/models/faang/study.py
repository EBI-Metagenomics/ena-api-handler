...
# Portal: faang | Result type: study
...
class FAANGStudyFields(str, Enum):
    """Returnable fields for study via the faang portal."""
...
class FAANGStudyQuery(ENABaseQuery):
    """Searchable fields for study via the faang portal."""
...
class FAANGStudyResult(BaseModel):
    """Typed result row for study via the faang portal."""
