...
# Portal: faang | Result type: sequence
...
class FAANGSequenceFields(str, Enum):
    """Returnable fields for sequence via the faang portal."""
...
class FAANGSequenceQuery(ENABaseQuery):
    """Searchable fields for sequence via the faang portal."""
...
class FAANGSequenceResult(BaseModel):
    """Typed result row for sequence via the faang portal."""
