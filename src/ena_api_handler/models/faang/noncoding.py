...
# Portal: faang | Result type: noncoding
...
class FAANGNoncodingFields(str, Enum):
    """Returnable fields for noncoding via the faang portal."""
...
class FAANGNoncodingQuery(ENABaseQuery):
    """Searchable fields for noncoding via the faang portal."""
...
class FAANGNoncodingResult(BaseModel):
    """Typed result row for noncoding via the faang portal."""
