...
# Portal: faang | Result type: analysis_study
...
class FAANGAnalysisStudyFields(str, Enum):
    """Returnable fields for analysis_study via the faang portal."""
...
class FAANGAnalysisStudyQuery(ENABaseQuery):
    """Searchable fields for analysis_study via the faang portal."""
...
class FAANGAnalysisStudyResult(BaseModel):
    """Typed result row for analysis_study via the faang portal."""
