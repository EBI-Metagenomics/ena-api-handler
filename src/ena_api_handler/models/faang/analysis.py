...
# Portal: faang | Result type: analysis
...
class FAANGAnalysisFields(str, Enum):
    """Returnable fields for analysis via the faang portal."""
...
class FAANGAnalysisQuery(ENABaseQuery):
    """Searchable fields for analysis via the faang portal."""
...
class FAANGAnalysisResult(BaseModel):
    """Typed result row for analysis via the faang portal."""
