...
# Portal: faang | Result type: wgs_set
...
class FAANGWgsSetFields(str, Enum):
    """Returnable fields for wgs_set via the faang portal."""
...
class FAANGWgsSetQuery(ENABaseQuery):
    """Searchable fields for wgs_set via the faang portal."""
...
class FAANGWgsSetResult(BaseModel):
    """Typed result row for wgs_set via the faang portal."""
