...
# Portal: pathogen | Result type: wgs_set
...
class PathogenWgsSetFields(str, Enum):
    """Returnable fields for wgs_set via the pathogen portal."""
...
class PathogenWgsSetQuery(ENABaseQuery):
    """Searchable fields for wgs_set via the pathogen portal."""
...
class PathogenWgsSetResult(BaseModel):
    """Typed result row for wgs_set via the pathogen portal."""
