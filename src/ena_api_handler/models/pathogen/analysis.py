...
# Portal: pathogen | Result type: analysis
...
class PathogenAnalysisFields(str, Enum):
    """Returnable fields for analysis via the pathogen portal."""
...
class PathogenAnalysisQuery(ENABaseQuery):
    """Searchable fields for analysis via the pathogen portal."""
...
class PathogenAnalysisResult(BaseModel):
    """Typed result row for analysis via the pathogen portal."""
