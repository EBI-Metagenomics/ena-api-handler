...
# Portal: pathogen | Result type: study
...
class PathogenStudyFields(str, Enum):
    """Returnable fields for study via the pathogen portal."""
...
class PathogenStudyQuery(ENABaseQuery):
    """Searchable fields for study via the pathogen portal."""
...
class PathogenStudyResult(BaseModel):
    """Typed result row for study via the pathogen portal."""
