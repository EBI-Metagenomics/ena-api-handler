...
# Portal: pathogen | Result type: read_run
...
class PathogenReadRunFields(str, Enum):
    """Returnable fields for read_run via the pathogen portal."""
...
class PathogenReadRunQuery(ENABaseQuery):
    """Searchable fields for read_run via the pathogen portal."""
...
class PathogenReadRunResult(BaseModel):
    """Typed result row for read_run via the pathogen portal."""
