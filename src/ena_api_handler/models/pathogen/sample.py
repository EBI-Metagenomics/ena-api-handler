...
# Portal: pathogen | Result type: sample
...
class PathogenSampleFields(str, Enum):
    """Returnable fields for sample via the pathogen portal."""
...
class PathogenSampleQuery(ENABaseQuery):
    """Searchable fields for sample via the pathogen portal."""
...
class PathogenSampleResult(BaseModel):
    """Typed result row for sample via the pathogen portal."""
