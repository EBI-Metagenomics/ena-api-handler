...
# Portal: pathogen | Result type: assembly
...
class PathogenAssemblyFields(str, Enum):
    """Returnable fields for assembly via the pathogen portal."""
...
class PathogenAssemblyQuery(ENABaseQuery):
    """Searchable fields for assembly via the pathogen portal."""
...
class PathogenAssemblyResult(BaseModel):
    """Typed result row for assembly via the pathogen portal."""
