...
# Portal: pathogen | Result type: tsa_set
...
class PathogenTsaSetFields(str, Enum):
    """Returnable fields for tsa_set via the pathogen portal."""
...
class PathogenTsaSetQuery(ENABaseQuery):
    """Searchable fields for tsa_set via the pathogen portal."""
...
class PathogenTsaSetResult(BaseModel):
    """Typed result row for tsa_set via the pathogen portal."""
