...
# Portal: pathogen | Result type: noncoding
...
class PathogenNoncodingFields(str, Enum):
    """Returnable fields for noncoding via the pathogen portal."""
...
class PathogenNoncodingQuery(ENABaseQuery):
    """Searchable fields for noncoding via the pathogen portal."""
...
class PathogenNoncodingResult(BaseModel):
    """Typed result row for noncoding via the pathogen portal."""
