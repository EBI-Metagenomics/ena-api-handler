...
# Portal: pathogen | Result type: read_study
...
class PathogenReadStudyFields(str, Enum):
    """Returnable fields for read_study via the pathogen portal."""
...
class PathogenReadStudyQuery(ENABaseQuery):
    """Searchable fields for read_study via the pathogen portal."""
...
class PathogenReadStudyResult(BaseModel):
    """Typed result row for read_study via the pathogen portal."""
