...
# Portal: pathogen | Result type: read_experiment
...
class PathogenReadExperimentFields(str, Enum):
    """Returnable fields for read_experiment via the pathogen portal."""
...
class PathogenReadExperimentQuery(ENABaseQuery):
    """Searchable fields for read_experiment via the pathogen portal."""
...
class PathogenReadExperimentResult(BaseModel):
    """Typed result row for read_experiment via the pathogen portal."""
