...
# Portal: pathogen | Result type: tls_set
...
class PathogenTlsSetFields(str, Enum):
    """Returnable fields for tls_set via the pathogen portal."""
...
class PathogenTlsSetQuery(ENABaseQuery):
    """Searchable fields for tls_set via the pathogen portal."""
...
class PathogenTlsSetResult(BaseModel):
    """Typed result row for tls_set via the pathogen portal."""
