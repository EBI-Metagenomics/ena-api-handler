...
# Portal: pathogen | Result type: sequence
...
class PathogenSequenceFields(str, Enum):
    """Returnable fields for sequence via the pathogen portal."""
...
class PathogenSequenceQuery(ENABaseQuery):
    """Searchable fields for sequence via the pathogen portal."""
...
class PathogenSequenceResult(BaseModel):
    """Typed result row for sequence via the pathogen portal."""
