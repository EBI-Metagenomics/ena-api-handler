...
# Portal: ena | Result type: read_experiment
...
class ENAReadExperimentFields(str, Enum):
    """Returnable fields for read_experiment via the ena portal."""
...
class ENAReadExperimentQuery(ENABaseQuery):
    """Searchable fields for read_experiment via the ena portal."""
...
class ENAReadExperimentResult(BaseModel):
    """Typed result row for read_experiment via the ena portal."""
