...
class ENAStudyFields(str, Enum):
    """Returnable fields for study via the ena portal."""
...
class ENAStudyQuery(ENABaseQuery):
    """Searchable fields for study via the ena portal."""
...
class ENAStudyResult(BaseModel):
    """Typed result row for study via the ena portal."""
