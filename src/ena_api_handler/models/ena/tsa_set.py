...
# Portal: ena | Result type: tsa_set
...
class ENATsaSetFields(str, Enum):
    """Returnable fields for tsa_set via the ena portal."""
...
class ENATsaSetQuery(ENABaseQuery):
    """Searchable fields for tsa_set via the ena portal."""
...
class ENATsaSetResult(BaseModel):
    """Typed result row for tsa_set via the ena portal."""
