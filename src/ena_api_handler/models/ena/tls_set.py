...
# Portal: ena | Result type: tls_set
...
class ENATlsSetFields(str, Enum):
    """Returnable fields for tls_set via the ena portal."""
...
class ENATlsSetQuery(ENABaseQuery):
    """Searchable fields for tls_set via the ena portal."""
...
class ENATlsSetResult(BaseModel):
    """Typed result row for tls_set via the ena portal."""
