...
# Portal: ena | Result type: analysis_study
...
class ENAAnalysisStudyFields(str, Enum):
    """Returnable fields for analysis_study via the ena portal."""
...
class ENAAnalysisStudyQuery(ENABaseQuery):
    """Searchable fields for analysis_study via the ena portal."""
...
class ENAAnalysisStudyResult(BaseModel):
    """Typed result row for analysis_study via the ena portal."""
