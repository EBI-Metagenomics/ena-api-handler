...
# Portal: ena | Result type: noncoding
...
class ENANoncodingFields(str, Enum):
    """Returnable fields for noncoding via the ena portal."""
...
class ENANoncodingQuery(ENABaseQuery):
    """Searchable fields for noncoding via the ena portal."""
...
class ENANoncodingResult(BaseModel):
    """Typed result row for noncoding via the ena portal."""
