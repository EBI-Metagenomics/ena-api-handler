...
# Portal: ena | Result type: read_study
...
class ENAReadStudyFields(str, Enum):
    """Returnable fields for read_study via the ena portal."""
...
class ENAReadStudyQuery(ENABaseQuery):
    """Searchable fields for read_study via the ena portal."""
...
class ENAReadStudyResult(BaseModel):
    """Typed result row for read_study via the ena portal."""
