...
# Portal: ena | Result type: analysis
...
class ENAAnalysisFields(str, Enum):
    """Returnable fields for analysis via the ena portal."""
...
class ENAAnalysisQuery(ENABaseQuery):
    """Searchable fields for analysis via the ena portal."""
...
class ENAAnalysisResult(BaseModel):
    """Typed result row for analysis via the ena portal."""
