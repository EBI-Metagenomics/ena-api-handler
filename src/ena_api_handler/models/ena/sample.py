...
class ENASampleFields(str, Enum):
    """Returnable fields for sample via the ena portal."""
...
class ENASampleQuery(ENABaseQuery):
    """Searchable fields for sample via the ena portal."""
...
class ENASampleResult(BaseModel):
    """Typed result row for sample via the ena portal."""
