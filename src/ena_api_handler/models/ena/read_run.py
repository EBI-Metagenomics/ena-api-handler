...
# Portal: ena | Result type: read_run
...
class ENAReadRunFields(str, Enum):
    """Returnable fields for read_run via the ena portal."""
...
class ENAReadRunQuery(ENABaseQuery):
    """Searchable fields for read_run via the ena portal."""
...
class ENAReadRunResult(BaseModel):
    """Typed result row for read_run via the ena portal."""
