...
# Portal: ena | Result type: sequence
...
class ENASequenceFields(str, Enum):
    """Returnable fields for sequence via the ena portal."""
...
class ENASequenceQuery(ENABaseQuery):
    """Searchable fields for sequence via the ena portal."""
...
class ENASequenceResult(BaseModel):
    """Typed result row for sequence via the ena portal."""
