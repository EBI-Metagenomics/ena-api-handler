...
# Portal: metagenome | Result type: read_experiment
...
class MetagenomeReadExperimentFields(str, Enum):
    """Returnable fields for read_experiment via the metagenome portal."""
...
class MetagenomeReadExperimentQuery(ENABaseQuery):
    """Searchable fields for read_experiment via the metagenome portal."""
...
class MetagenomeReadExperimentResult(BaseModel):
    """Typed result row for read_experiment via the metagenome portal."""
