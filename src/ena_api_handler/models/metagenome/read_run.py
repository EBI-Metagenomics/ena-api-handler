...
# Portal: metagenome | Result type: read_run
...
class MetagenomeReadRunFields(str, Enum):
    """Returnable fields for read_run via the metagenome portal."""
...
class MetagenomeReadRunQuery(ENABaseQuery):
    """Searchable fields for read_run via the metagenome portal."""
...
class MetagenomeReadRunResult(BaseModel):
    """Typed result row for read_run via the metagenome portal."""
