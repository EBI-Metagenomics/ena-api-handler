...
# Portal: metagenome | Result type: sample
...
class MetagenomeSampleFields(str, Enum):
    """Returnable fields for sample via the metagenome portal."""
...
class MetagenomeSampleQuery(ENABaseQuery):
    """Searchable fields for sample via the metagenome portal."""
...
class MetagenomeSampleResult(BaseModel):
    """Typed result row for sample via the metagenome portal."""
