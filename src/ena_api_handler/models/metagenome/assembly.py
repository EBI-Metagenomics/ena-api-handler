...
# Portal: metagenome | Result type: assembly
...
class MetagenomeAssemblyFields(str, Enum):
    """Returnable fields for assembly via the metagenome portal."""
...
class MetagenomeAssemblyQuery(ENABaseQuery):
    """Searchable fields for assembly via the metagenome portal."""
...
class MetagenomeAssemblyResult(BaseModel):
    """Typed result row for assembly via the metagenome portal."""
