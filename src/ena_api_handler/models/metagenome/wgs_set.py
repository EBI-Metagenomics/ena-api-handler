...
# Portal: metagenome | Result type: wgs_set
...
class MetagenomeWgsSetFields(str, Enum):
    """Returnable fields for wgs_set via the metagenome portal."""
...
class MetagenomeWgsSetQuery(ENABaseQuery):
    """Searchable fields for wgs_set via the metagenome portal."""
...
class MetagenomeWgsSetResult(BaseModel):
    """Typed result row for wgs_set via the metagenome portal."""
