...
# Portal: metagenome | Result type: analysis
...
class MetagenomeAnalysisFields(str, Enum):
    """Returnable fields for analysis via the metagenome portal."""
...
class MetagenomeAnalysisQuery(ENABaseQuery):
    """Searchable fields for analysis via the metagenome portal."""
...
class MetagenomeAnalysisResult(BaseModel):
    """Typed result row for analysis via the metagenome portal."""
