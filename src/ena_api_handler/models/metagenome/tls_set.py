...
# Portal: metagenome | Result type: tls_set
...
class MetagenomeTlsSetFields(str, Enum):
    """Returnable fields for tls_set via the metagenome portal."""
...
class MetagenomeTlsSetQuery(ENABaseQuery):
    """Searchable fields for tls_set via the metagenome portal."""
...
class MetagenomeTlsSetResult(BaseModel):
    """Typed result row for tls_set via the metagenome portal."""
