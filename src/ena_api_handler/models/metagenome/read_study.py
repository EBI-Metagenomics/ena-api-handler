...
# Portal: metagenome | Result type: read_study
...
class MetagenomeReadStudyFields(str, Enum):
    """Returnable fields for read_study via the metagenome portal."""
...
class MetagenomeReadStudyQuery(ENABaseQuery):
    """Searchable fields for read_study via the metagenome portal."""
...
class MetagenomeReadStudyResult(BaseModel):
    """Typed result row for read_study via the metagenome portal."""
