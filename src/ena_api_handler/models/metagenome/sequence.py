...
# Portal: metagenome | Result type: sequence
...
class MetagenomeSequenceFields(str, Enum):
    """Returnable fields for sequence via the metagenome portal."""

    ACCESSION = "accession"  # accession number
    AGRICOLA_ID = "agricola_id"  # Agricola ID
    ...
    PATENT_NUMBER = "patent_number"  # Patent Number
...
class MetagenomeSequenceQuery(ENABaseQuery):
    """Searchable fields for sequence via the metagenome portal."""

    accession: Optional[str] = Field(default=None, description="accession number")
    agricola_id: Optional[str] = Field(default=None, description="Agricola ID")
...
class MetagenomeSequenceResult(BaseModel):
    """Typed result row for sequence via the metagenome portal."""
