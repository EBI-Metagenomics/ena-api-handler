...
# Portal: metagenome | Result type: tsa_set
...
class MetagenomeTsaSetFields(str, Enum):
    """Returnable fields for tsa_set via the metagenome portal."""
...
class MetagenomeTsaSetQuery(ENABaseQuery):
    """Searchable fields for tsa_set via the metagenome portal."""
...
class MetagenomeTsaSetResult(BaseModel):
    """Typed result row for tsa_set via the metagenome portal."""
