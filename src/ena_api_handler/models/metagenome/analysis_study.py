...
# Portal: metagenome | Result type: analysis_study
...
class MetagenomeAnalysisStudyFields(str, Enum):
    """Returnable fields for analysis_study via the metagenome portal."""
...
class MetagenomeAnalysisStudyQuery(ENABaseQuery):
    """Searchable fields for analysis_study via the metagenome portal."""
...
class MetagenomeAnalysisStudyResult(BaseModel):
    """Typed result row for analysis_study via the metagenome portal."""
